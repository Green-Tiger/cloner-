...
def linex():
	os.system('echo  "\n ======================================\n" | lolcat -a -d 2 -s 50')
def logo():
	os.system('echo "\n  888888 88""Yb      dP""b8 88      dP"Yb  88b 88 888888 
88__   88__dP     dP   `" 88     dP   Yb 88Yb88 88__   
88""   88""Yb     Yb      88  .o Yb   dP 88 Y88 88""   
88     88oodP      YboodP 88ood8  YbodP  88  Y8 888888 " | lolcat -a -d 2 -s 50')	
...
def crack_select1():
	...
	print("\033[94;1m  please Wait clone account will b appear here")
	linex()
	def main(arg):
		user=arg
		uid,name=user.split("|")
...
def crack_select():
	...
	print("\033[93;1m  TOTAL IDS : \033[92;1m"+str(len(id)))
	print("\033[92;1m  BRUTE HAS BEEN STARTED\x1b[0m")
	print("\033[94;1m  please wait cloning account will b appear here")
	linex()
	def main(arg):
		user=arg
		uid,name=user.split("|")
